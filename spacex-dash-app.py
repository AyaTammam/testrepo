...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(id='payload-slider',min=0, max=10000, step=1000, marks={i: str(i) for i in range(0, 10001, 1000)},
...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.pie(filtered_df, names = 'class', hole=.3, color_discrete_sequence=px.colors.sequential.RdBu, title=f'Total Success Launches for site {entered_site}')
    return fig
